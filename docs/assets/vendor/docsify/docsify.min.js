!(function () {
  ...
  function a(e) {
    let n = e.match(/^([^:/?#]+:)?(?:\/{2,}([^/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/);
    return (
      ("string" == typeof n[1] && n[1].length > 0 && n[1].toLowerCase() !== location.protocol) ||
      ("string" == typeof n[2] &&
        n[2].length > 0 &&
  ...
  const c = document.body.clientWidth <= 600,
    r = {};
  function s(e, n = !1) {
    if ("string" == typeof e) {
  ...
  function A(e, n = []) {
    const i = [];
    for (const t in e) n.indexOf(t) > -1 || i.push(e[t] ? `${x(t)}=${x(e[t])}`.toLowerCase() : x(t));
    return i.length ? `?${i.join("&")}` : "";
  }
  const S = e((e) => /(:|(\/{2}))/g.test(e)),
    z = e((e) => e.split(/[?#]/)[0]),
    E = e((e) => {
  ...
  function R(...e) {
    return T(e.map(L).join("/"));
  }
  const C = e((e) => e.replace("#", "?id="));
  class j {
    #e = {};
    constructor(e) {
      this.config = e;
    ...
    #i(e, n) {
      return new RegExp(`\\.(${n.replace(/^\./, "")}|html)$`, "g").test(e)
        ? e
        : /\/$/g.test(e)
        ? `${e}README${n}`
        : `${e}${n}`;
    ...
    getFile(e = this.getCurrentPath(), n) {
      const { config: i } = this,
        t = this.getBasePath(),
        o = "string" == typeof i.ext ? i.ext : ".md";
      return (
        (e = i.alias ? this.#n(e, i.alias) : e),
        (e = ((e = this.#i(e, o)) === `/README${o}` && i.homepage) || e),
        (e = S(e) ? e : R(t, e)),
        n && (e = e.replace(new RegExp(`^${t}`), "")),
        e
      );
    }
    onchange(e = t) {
    ...
    toURL(e, n, i) {
      const t = i && "#" === e[0],
        o = this.parse(C(e));
      if (((o.query = { ...o.query, ...n }), (e = (e = o.path + A(o.query)).replace(/\.md(\?)|\.md$/, "$1")), t)) {
        const n = i.indexOf("?");
  ...
  class q extends j {
    ...
    normalize() {
      ...
      if (((e = C(e)), "/" === e.charAt(0))) return O(e);
      O("/" + e);
    }
    parse(e = location.href) {
      ...
      return (
        ...
        { path: e, file: this.getFile(e, !0), query: $(n), response: {} }
      );
    }
    toURL(e, n, i) {
  ...
  class P extends j {
    ...
    getCurrentPath() {
      ...
      return (
        e && 0 === n.indexOf(e) && (n = n.slice(e.length)), (n || "/") + window.location.search + window.location.hash
      );
    }
    onchange(e = t) {
      _("click", (n) => {
    ...
    parse(e = location.href) {
      ...
      const t = R(location.origin),
        o = e.indexOf(t);
      return o > -1 && (e = e.slice(o + t.length)), { path: e, file: this.getFile(e), query: $(n), response: {} };
    }
  }
  let M = {};
  var I = /([^{]*?)\w(?=\})/g,
  ...
  function W(e, n) {
    if (n) {
      if (B.test(e)) return e.replace(U, Y);
    } else if (Z.test(e)) return e.replace(V, Y);
    return e;
  }
  ...
  function J(e, n) {
    ...
    const i = {
      replace: (n, t) => ((t = (t = t.source || t).replace(K, "$1")), (e = e.replace(n, t)), i),
  ...
  function ie(e, n, i) {
    if (e) {
      let e;
      try {
        e = decodeURIComponent(X(i)).replace(ee, "").toLowerCase();
      } catch (e) {
        return null;
      }
    ...
    n &&
      !ne.test(i) &&
      (i = (function (e, n) {
        te[" " + e] || (oe.test(e) ? (te[" " + e] = e + "/") : (te[" " + e] = ue(e, "/", !0)));
        e = te[" " + e];
        const i = -1 === e.indexOf(":");
  ...
  function de(e, n) {
    if (n < 1) return "";
    let i = "";
    for (; n > 1; ) 1 & n && (i += e), (n >>= 1), (e += e);
    return i + e;
  }
  function fe(e, n, i, t) {
    const o = n.href,
      a = n.title ? W(n.title) : null,
      c = e[1].replace(/\\([\[\]])/g, "$1");
    if ("!" !== e[0].charAt(0)) {
      t.state.inLink = !0;
    ...
    return { type: "image", raw: i, href: o, title: a, text: W(c) };
  }
  class ge {
    constructor(e) {
      this.options = e || D;
    ...
    code(e) {
      ...
      if (n) {
        ...
        return { type: "code", raw: n[0], codeBlockStyle: "indented", text: this.options.pedantic ? e : ue(e, "\n") };
      }
    }
    fences(e) {
    ...
    list(e) {
      ...
      if (n) {
        let i,
          ...
          l = n[1].trim();
        const v = l.length > 1,
          h = { type: "list", raw: "", ordered: v, start: v ? +l.slice(0, -1) : "", loose: !1, items: [] };
        (l = v ? `\\d{1,9}\\${l.slice(-1)}` : `\\${l}`), this.options.pedantic && (l = v ? l : "[*+-]");
        const _ = new RegExp(`^( {0,3}${l})((?:[\t ][^\\n]*)?(?:\\n|$))`);
        for (; e && ((p = !1), (n = _.exec(e))) && !this.rules.block.hr.test(e); ) {
          if (
            ((i = n[0]),
            ...
            this.options.pedantic
              ? ((a = 2), (g = u.trimLeft()))
              : ((a = n[2].search(/[^ ]/)), (a = a > 4 ? 1 : a), (g = u.slice(a)), (a += n[1].length)),
            (r = !1),
            !u && /^ *$/.test(d) && ((i += d + "\n"), (e = e.substring(d.length + 1)), (p = !0)),
            !p)
          ) {
            const n = new RegExp(`^ {0,${Math.min(3, a - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ \t][^\\n]*)?(?:\\n|$))`),
              t = new RegExp(`^ {0,${Math.min(3, a - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),
              o = new RegExp(`^ {0,${Math.min(3, a - 1)}}(?:\`\`\`|~~~)`),
              c = new RegExp(`^ {0,${Math.min(3, a - 1)}}#`);
            for (
              ;
              e &&
              ((f = e.split("\n", 1)[0]),
              ...
              r || d.trim() || (r = !0), (i += f + "\n"), (e = e.substring(f.length + 1)), (u = d.slice(a));
            }
          }
          h.loose || (s ? (h.loose = !0) : /\n *\n *$/.test(i) && (s = !0)),
            this.options.gfm &&
              ((t = /^\[[ xX]\] /.exec(g)), t && ((o = "[ ] " !== t[0]), (g = g.replace(/^\[[ xX]\] +/, "")))),
            h.items.push({ type: "list_item", raw: i, task: !!t, checked: o, loose: !1, text: g }),
            (h.raw += i);
        }
        (h.items[h.items.length - 1].raw = i.trimRight()),
          (h.items[h.items.length - 1].text = g.trimRight()),
          (h.raw = h.raw.trimRight());
        const m = h.items.length;
        for (c = 0; c < m; c++)
          if (
            ((this.lexer.state.top = !1), (h.items[c].tokens = this.lexer.blockTokens(h.items[c].text, [])), !h.loose)
          ) {
            const e = h.items[c].tokens.filter((e) => "space" === e.type),
              n = e.length > 0 && e.some((e) => /\n.*\n/.test(e.raw));
            h.loose = n;
          }
        if (h.loose) for (c = 0; c < m; c++) h.items[c].loose = !0;
        return h;
      }
    }
    html(e) {
      ...
      if (n) {
        ...
        if (this.options.sanitize) {
          const i = this.options.sanitizer ? this.options.sanitizer(n[0]) : W(n[0]);
    ...
    def(e) {
      ...
      if (n) {
        const e = n[1].toLowerCase().replace(/\s+/g, " "),
          ...
          t = n[3] ? n[3].substring(1, n[3].length - 1).replace(this.rules.inline._escapes, "$1") : n[3];
        ...
        if (e.header.length === e.align.length) {
          ...
          for (i = 0; i < c; i++)
            /^ *-+: *$/.test(e.align[i])
              ...
              ? (e.align[i] = "left")
              : (e.align[i] = null);
          for (c = e.rows.length, i = 0; i < c; i++)
            e.rows[i] = se(e.rows[i], e.header.length).map((e) => ({ text: e }));
          for (c = e.header.length, t = 0; t < c; t++) e.header[t].tokens = this.lexer.inline(e.header[t].text);
          for (c = e.rows.length, t = 0; t < c; t++)
            for (a = e.rows[t], o = 0; o < a.length; o++) a[o].tokens = this.lexer.inline(a[o].text);
          return e;
        }
      }
    }
    ...
    escape(e) {
      ...
      if (n) return { type: "escape", raw: n[0], text: W(n[1]) };
    }
    tag(e) {
      ...
      if (n)
        return (
              ...
              (this.lexer.state.inRawBlock = !1),
          {
            ...
            text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(n[0]) : W(n[0])) : n[0],
          }
        );
    }
    link(e) {
        ...
        if (!this.options.pedantic && /^</.test(e)) {
          ...
          const e = (function (e, n) {
            ...
            for (; o < i; o++)
              ...
              else if (e[o] === n[1] && (t--, t < 0)) return o;
            return -1;
          })(n[2], "()");
          if (e > -1) {
        ...
        return (
          ...
          fe(
            n,
            {
              ...
              title: t ? t.replace(this.rules.inline._escapes, "$1") : t,
            },
            n[0],
            this.lexer
          )
    ...
    emStrong(e, n, i = "") {
      ...
      if (!o || (o && ("" === i || this.rules.inline.punctuation.exec(i)))) {
        ...
        let o,
          ...
          c = i,
          r = 0;
        const s = "*" === t[0][0] ? this.rules.inline.emStrong.rDelimAst : this.rules.inline.emStrong.rDelimUnd;
        for (s.lastIndex = 0, n = n.slice(-1 * e.length + i); null != (t = s.exec(n)); ) {
          ...
          if (((c -= a), c > 0)) continue;
          a = Math.min(a, a + c + r);
          const n = e.slice(0, i + t.index + (t[0].length - o.length) + a);
          if (Math.min(i, a) % 2) {
            const e = n.slice(1, -1);
            return { type: "em", raw: n, text: e, tokens: this.lexer.inlineTokens(e) };
          }
          const s = n.slice(2, -2);
          return { type: "strong", raw: n, text: s, tokens: this.lexer.inlineTokens(s) };
        }
      }
    }
    codespan(e) {
      ...
      if (n) {
        ...
        const i = /[^ ]/.test(e),
          t = /^ /.test(e) && / $/.test(e);
        return i && t && (e = e.substring(1, e.length - 1)), (e = W(e, !0)), { type: "codespan", raw: n[0], text: e };
      }
    }
    br(e) {
    ...
    autolink(e, n) {
      ...
      if (i) {
        ...
        return (
          "@" === i[2]
            ? ((e = W(this.options.mangle ? n(i[1]) : i[1])), (t = "mailto:" + e))
            : ((e = W(i[1])), (t = e)),
          { type: "link", raw: i[0], text: e, href: t, tokens: [{ type: "text", raw: e, text: e }] }
        );
      }
    }
    url(e, n) {
      ...
      if ((i = this.rules.inline.url.exec(e))) {
        let e, t;
        if ("@" === i[2]) (e = W(this.options.mangle ? n(i[0]) : i[0])), (t = "mailto:" + e);
        else {
          let n;
          do {
            (n = i[0]), (i[0] = this.rules.inline._backpedal.exec(i[0])[0]);
          } while (n !== i[0]);
          (e = W(i[0])), (t = "www." === i[1] ? "http://" + i[0] : i[0]);
        }
        return { type: "link", raw: i[0], text: e, href: t, tokens: [{ type: "text", raw: e, text: e }] };
      }
    }
    inlineText(e, n) {
          ...
          (e = this.lexer.state.inRawBlock
            ? this.options.sanitize
              ? this.options.sanitizer
                ...
                : W(i[0])
              : i[0]
            : W(this.options.smartypants ? n(i[0]) : i[0])),
  ...
  (pe.def = J(pe.def).replace("label", pe._label).replace("title", pe._title).getRegex()),
    (pe.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (pe.listItemStart = J(/^( *)(bull) */)
    ...
    (pe.paragraph = J(pe._paragraph)
      ...
      .replace("tag", pe._tag)
      .getRegex()),
    (pe.blockquote = J(pe.blockquote).replace("paragraph", pe.paragraph).getRegex()),
    (pe.normal = { ...pe }),
    (pe.gfm = {
      ...pe.normal,
      table:
    ...
    (pe.gfm.table = J(pe.gfm.table)
      ...
      .replace("tag", pe._tag)
      .getRegex()),
    (pe.gfm.paragraph = J(pe._paragraph)
      .replace("hr", pe.hr)
      .replace("heading", " {0,3}#{1,6} ")
      .replace("|lheading", "")
    ...
    (pe.pedantic = {
      ...
      fences: re,
      lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,
      paragraph: J(pe.normal._paragraph)
        .replace("hr", pe.hr)
        .replace("heading", " *#{1,6} *[^\n]")
  ...
  function he(e) {
    ...
    const o = e.length;
    for (n = 0; n < o; n++)
      (i = e.charCodeAt(n)), Math.random() > 0.5 && (i = "x" + i.toString(16)), (t += "&#" + i + ";");
    return t;
  }
  (le._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    (le.punctuation = J(le.punctuation)
      .replace(/punctuation/g, le._punctuation)
      .getRegex()),
    (le.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (le.escapedEmSt = /(?:^|[^\\])(?:\\\\)*\\[*_]/g),
    (le._comment = J(pe._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
    (le.emStrong.lDelim = J(le.emStrong.lDelim).replace(/punct/g, le._punctuation).getRegex()),
    (le.emStrong.rDelimAst = J(le.emStrong.rDelimAst, "g").replace(/punct/g, le._punctuation).getRegex()),
    (le.emStrong.rDelimUnd = J(le.emStrong.rDelimUnd, "g").replace(/punct/g, le._punctuation).getRegex()),
    (le._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (le._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (le._email =
      /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (le.autolink = J(le.autolink).replace("scheme", le._scheme).replace("email", le._email).getRegex()),
    (le._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (le.tag = J(le.tag).replace("comment", le._comment).replace("attribute", le._attribute).getRegex()),
    (le._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (le._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (le._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (le.link = J(le.link).replace("label", le._label).replace("href", le._href).replace("title", le._title).getRegex()),
    (le.reflink = J(le.reflink).replace("label", le._label).replace("ref", pe._label).getRegex()),
    (le.nolink = J(le.nolink).replace("ref", pe._label).getRegex()),
    (le.reflinkSearch = J(le.reflinkSearch, "g")
      .replace("reflink", le.reflink)
      .replace("nolink", le.nolink)
      .getRegex()),
    (le.normal = { ...le }),
    (le.pedantic = {
      ...le.normal,
    ...
    (le.gfm = {
      ...le.normal,
      escape: J(le.escape).replace("])", "~|])").getRegex(),
    ...
    (le.gfm.url = J(le.gfm.url, "i").replace("email", le.gfm._extended_email).getRegex()),
    (le.breaks = {
      ...le.gfm,
      br: J(le.br).replace("{2,}", "*").getRegex(),
      text: J(le.gfm.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
  ...
  class _e {
    constructor(e) {
      (this.tokens = []),
        ...
        (this.options = e || D),
        (this.options.tokenizer = this.options.tokenizer || new ge()),
        (this.tokenizer = this.options.tokenizer),
        (this.tokenizer.options = this.options),
        (this.tokenizer.lexer = this),
        (this.inlineQueue = []),
        (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
      const n = { block: pe.normal, inline: le.normal };
      this.options.pedantic
        ? ((n.block = pe.pedantic), (n.inline = le.pedantic))
        : this.options.gfm && ((n.block = pe.gfm), this.options.breaks ? (n.inline = le.breaks) : (n.inline = le.gfm)),
        (this.tokenizer.rules = n);
    }
    static get rules() {
      return { block: pe, inline: le };
    }
    static lex(e, n) {
      return new _e(n).lex(e);
    }
    static lexInline(e, n) {
      return new _e(n).inlineTokens(e);
    }
    lex(e) {
      let n;
      for (e = e.replace(/\r\n|\r/g, "\n"), this.blockTokens(e, this.tokens); (n = this.inlineQueue.shift()); )
    ...
    blockTokens(e, n = []) {
      ...
      for (
        e = this.options.pedantic
          ...
          : e.replace(/^( *)(\t+)/gm, (e, n, i) => n + "    ".repeat(i.length));
        e;
        ...
        if (
          !(
            ...
            this.options.extensions.block.some(
              (t) => !!(i = t.call({ lexer: this }, e, n)) && ((e = e.substring(i.raw.length)), n.push(i), !0)
            )
          )
        )
          if ((i = this.tokenizer.space(e)))
            (e = e.substring(i.raw.length)),
              1 === i.raw.length && n.length > 0 ? (n[n.length - 1].raw += "\n") : n.push(i);
          else if ((i = this.tokenizer.code(e)))
            (e = e.substring(i.raw.length)),
              (t = n[n.length - 1]),
              !t || ("paragraph" !== t.type && "text" !== t.type)
                ? n.push(i)
                : ((t.raw += "\n" + i.raw),
                  (t.text += "\n" + i.text),
            ...
            if (((o = e), this.options.extensions && this.options.extensions.startBlock)) {
              ...
              this.options.extensions.startBlock.forEach(function (e) {
                (t = e.call({ lexer: this }, i)), "number" == typeof t && t >= 0 && (n = Math.min(n, t));
              }),
      ...
      for (; e; )
        if (
          ...
          if ((i = this.tokenizer.escape(e))) (e = e.substring(i.raw.length)), n.push(i);
            ...
            (e = e.substring(i.raw.length)),
              (t = n[n.length - 1]),
              t && "text" === i.type && "text" === t.type ? ((t.raw += i.raw), (t.text += i.text)) : n.push(i);
          else if ((i = this.tokenizer.link(e))) (e = e.substring(i.raw.length)), n.push(i);
          else if ((i = this.tokenizer.reflink(e, this.tokens.links)))
            (e = e.substring(i.raw.length)),
              (t = n[n.length - 1]),
              t && "text" === i.type && "text" === t.type ? ((t.raw += i.raw), (t.text += i.text)) : n.push(i);
          else if ((i = this.tokenizer.emStrong(e, s, r))) (e = e.substring(i.raw.length)), n.push(i);
          ...
          else if ((i = this.tokenizer.autolink(e, he))) (e = e.substring(i.raw.length)), n.push(i);
          else if (this.state.inLink || !(i = this.tokenizer.url(e, he))) {
            ...
            if ((i = this.tokenizer.inlineText(o, ve)))
              (e = e.substring(i.raw.length)),
                "_" !== i.raw.slice(-1) && (r = i.raw.slice(-1)),
                (c = !0),
                (t = n[n.length - 1]),
                t && "text" === t.type ? ((t.raw += i.raw), (t.text += i.text)) : n.push(i);
            else if (e) {
              const n = "Infinite loop on byte: " + e.charCodeAt(0);
              if (this.options.silent) {
                console.error(n);
          ...
          } else (e = e.substring(i.raw.length)), n.push(i);
      return n;
    }
  }
  class me {
    ...
    code(e, n, i) {
      ...
      if (this.options.highlight) {
        const n = this.options.highlight(e, t);
        null != n && n !== e && ((i = !0), (e = n));
      }
      return (
        (e = e.replace(/\n$/, "") + "\n"),
        t
          ? '<pre><code class="' + this.options.langPrefix + W(t) + '">' + (i ? e : W(e, !0)) + "</code></pre>\n"
    ...
    heading(e, n, i, t) {
      if (this.options.headerIds) {
        return `<h${n} id="${this.options.headerPrefix + t.slug(i)}">${e}</h${n}>\n`;
      }
      return `<h${n}>${e}</h${n}>\n`;
    }
    hr() {
    ...
    link(e, n, i) {
      if (null === (e = ie(this.options.sanitize, this.options.baseUrl, e))) return i;
      let t = '<a href="' + e + '"';
      return n && (t += ' title="' + n + '"'), (t += ">" + i + "</a>"), t;
    }
    image(e, n, i) {
      if (null === (e = ie(this.options.sanitize, this.options.baseUrl, e))) return i;
  ...
  class ke {
    ...
    getNextSafeSlug(e, n) {
      ...
      return n || ((this.seen[e] = t), (this.seen[i] = 0)), i;
    }
    slug(e, n = {}) {
  ...
  class we {
    constructor(e) {
      (this.options = e || D),
        (this.options.renderer = this.options.renderer || new me()),
        (this.renderer = this.options.renderer),
        (this.renderer.options = this.options),
        (this.textRenderer = new be()),
        (this.slugger = new ke());
    }
    static parse(e, n) {
      return new we(n).parse(e);
    }
    static parseInline(e, n) {
      return new we(n).parseInline(e);
    }
    parse(e, n = !0) {
      let i,
        t,
      ...
      for (i = 0; i < y; i++)
        if (
          ...
          this.options.extensions &&
            ...
            ((k = this.options.extensions.renderers[f.type].call({ parser: this }, f)),
            !1 !== k ||
          ...
          switch (f.type) {
            ...
            case "heading":
              w += this.renderer.heading(
                ...
                f.depth,
                X(this.parseInline(f.tokens, this.textRenderer)),
                this.slugger
              );
              continue;
            case "code":
              ...
              continue;
            case "table":
              for (u = "", s = "", a = f.header.length, t = 0; t < a; t++)
                s += this.renderer.tablecell(this.parseInline(f.header[t].tokens), { header: !0, align: f.align[t] });
              for (u += this.renderer.tablerow(s), d = "", a = f.rows.length, t = 0; t < a; t++) {
                for (r = f.rows[t], s = "", c = r.length, o = 0; o < c; o++)
                  s += this.renderer.tablecell(this.parseInline(r[o].tokens), { header: !1, align: f.align[o] });
                d += this.renderer.tablerow(s);
              }
              w += this.renderer.table(u, d);
              continue;
            case "blockquote":
              (d = this.parse(f.tokens)), (w += this.renderer.blockquote(d));
              continue;
            case "list":
              for (g = f.ordered, p = f.start, l = f.loose, a = f.items.length, d = "", t = 0; t < a; t++)
                (h = f.items[t]),
                  (_ = h.checked),
                  (m = h.task),
                  (v = ""),
                  h.task &&
                    ((b = this.renderer.checkbox(_)),
                    l
                      ? h.tokens.length > 0 && "paragraph" === h.tokens[0].type
                        ? ((h.tokens[0].text = b + " " + h.tokens[0].text),
                          h.tokens[0].tokens &&
                            h.tokens[0].tokens.length > 0 &&
                            "text" === h.tokens[0].tokens[0].type &&
                            (h.tokens[0].tokens[0].text = b + " " + h.tokens[0].tokens[0].text))
                        : h.tokens.unshift({ type: "text", text: b })
                      : (v += b)),
                  (v += this.parse(h.tokens, l)),
                  (d += this.renderer.listitem(v, m, _));
              w += this.renderer.list(d, g, p);
              continue;
            case "html":
            ...
            case "paragraph":
              ...
              continue;
            case "text":
              for (d = f.tokens ? this.parseInline(f.tokens) : f.text; i + 1 < y && "text" === e[i + 1].type; )
                (f = e[++i]), (d += "\n" + (f.tokens ? this.parseInline(f.tokens) : f.text));
              w += n ? this.renderer.paragraph(d) : d;
              continue;
            default: {
    ...
    parseInline(e, n) {
      ...
      for (i = 0; i < c; i++)
        if (
          ...
          this.options.extensions &&
            this.options.extensions.renderers &&
            this.options.extensions.renderers[t.type] &&
            ((o = this.options.extensions.renderers[t.type].call({ parser: this }, t)),
            !1 !== o ||
              !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(t.type)))
        )
          a += o || "";
        else
          switch (t.type) {
            ...
            case "html":
              ...
              break;
            case "link":
              a += n.link(t.href, t.title, this.parseInline(t.tokens, n));
              break;
            case "image":
              a += n.image(t.href, t.title, t.text);
              break;
            case "strong":
              a += n.strong(this.parseInline(t.tokens, n));
              break;
            case "em":
              a += n.em(this.parseInline(t.tokens, n));
              break;
            case "codespan":
              a += n.codespan(t.text);
              break;
            case "br":
              ...
              break;
            case "del":
              a += n.del(this.parseInline(t.tokens, n));
              break;
            default: {
              const e = 'Token with "' + t.type + '" type was not found.';
              if (this.options.silent) return void console.error(e);
              throw new Error(e);
            }
          }
  ...
  function xe(e, n) {
    return (i, t, o) => {
        ...
        c = (function (e, n, i) {
          return (t) => {
            if (((t.message += "\nPlease report this to https://github.com/markedjs/marked."), e)) {
              const e = "<p>An error occurred:</p><pre>" + W(t.message + "", !0) + "</pre>";
              return n ? Promise.resolve(e) : i ? void i(null, e) : e;
            }
            if (n) return Promise.reject(t);
            if (!i) throw t;
            i(t);
          };
        })((t = { ...$e.defaults, ...a }).silent, t.async, o);
      if (null == i) return c(new Error("marked(): input parameter is undefined or null"));
      if ("string" != typeof i)
        return c(
          new Error("marked(): input parameter is of type " + Object.prototype.toString.call(i) + ", string expected")
        );
      if (
        ((function (e) {
          e &&
        ...
        let r;
        try {
          t.hooks && (i = t.hooks.preprocess(i)), (r = e(i, t));
        } catch (e) {
          return c(e);
        }
        const s = function (e) {
          ...
          if (!e)
            try {
              t.walkTokens && $e.walkTokens(r, t.walkTokens), (i = n(r, t)), t.hooks && (i = t.hooks.postprocess(i));
            } catch (n) {
              e = n;
            }
          return (t.highlight = a), e ? c(e) : o(null, i);
        };
        if (!a || a.length < 3) return s();
        if ((delete t.highlight, !r.length)) return s();
        let u = 0;
        return (
          $e.walkTokens(r, function (e) {
            "code" === e.type &&
              (u++,
              setTimeout(() => {
                a(e.text, e.lang, function (n, i) {
                  if (n) return s(n);
                  null != i && i !== e.text && ((e.text = i), (e.escaped = !0)), u--, 0 === u && s();
                });
              }, 0));
          }),
          void (0 === u && s())
      ...
      if (t.async)
        return Promise.resolve(t.hooks ? t.hooks.preprocess(i) : i)
          .then((n) => e(n, t))
          .then((e) => (t.walkTokens ? Promise.all($e.walkTokens(e, t.walkTokens)).then(() => e) : e))
          .then((e) => n(e, t))
          .then((e) => (t.hooks ? t.hooks.postprocess(e) : e))
          .catch(c);
      try {
        t.hooks && (i = t.hooks.preprocess(i));
        const o = e(i, t);
        t.walkTokens && $e.walkTokens(o, t.walkTokens);
        let a = n(o, t);
  ...
  function $e(e, n, i) {
    return xe(_e.lex, we.parse)(e, n, i);
  }
  function Ae(e, n = '<ul class="app-sub-sidebar">{inner}</ul>') {
    if (!e || !e.length) return "";
    let i = "";
    return (
      e.forEach((e) => {
        const t = e.title.replace(/(<([^>]+)>)/g, "");
        (i += `<li><a class="section-link" href="${e.slug}" title="${t}">${e.title}</a></li>`),
          e.children && (i += Ae(e.children, n));
      }),
      n.replace("{inner}", i)
    );
  }
  ...
  ($e.options = $e.setOptions =
    function (e) {
      var n;
      return ($e.defaults = { ...$e.defaults, ...e }), (n = $e.defaults), (D = n), $e;
    }),
    ($e.getDefaults = H),
    ($e.defaults = D),
    ($e.use = function (...e) {
      const n = $e.defaults.extensions || { renderers: {}, childTokens: {} };
      e.forEach((e) => {
        const i = { ...e };
        if (
          ((i.async = $e.defaults.async || i.async || !1),
          e.extensions &&
            (e.extensions.forEach((e) => {
              if (!e.name) throw new Error("extension name required");
              if (e.renderer) {
                const i = n.renderers[e.name];
                n.renderers[e.name] = i
                  ? function (...n) {
                      let t = e.renderer.apply(this, n);
                      return !1 === t && (t = i.apply(this, n)), t;
                    }
                  : e.renderer;
              }
              if (e.tokenizer) {
          ...
          const n = $e.defaults.renderer || new me();
          for (const i in e.renderer) {
            const t = n[i];
            n[i] = (...o) => {
              let a = e.renderer[i].apply(n, o);
              return !1 === a && (a = t.apply(n, o)), a;
            };
          }
          i.renderer = n;
        }
        if (e.tokenizer) {
          const n = $e.defaults.tokenizer || new ge();
          for (const i in e.tokenizer) {
            const t = n[i];
            n[i] = (...o) => {
              let a = e.tokenizer[i].apply(n, o);
              return !1 === a && (a = t.apply(n, o)), a;
            };
          }
          i.tokenizer = n;
        ...
        if (e.hooks) {
          const n = $e.defaults.hooks || new ye();
          for (const i in e.hooks) {
            const t = n[i];
            ye.passThroughHooks.has(i)
              ? (n[i] = (o) => {
                  if ($e.defaults.async) return Promise.resolve(e.hooks[i].call(n, o)).then((e) => t.call(n, e));
                  const a = e.hooks[i].call(n, o);
                  return t.call(n, a);
                })
              : (n[i] = (...o) => {
                  let a = e.hooks[i].apply(n, o);
                  return !1 === a && (a = t.apply(n, o)), a;
                });
          }
          i.hooks = n;
        ...
        if (e.walkTokens) {
          const n = $e.defaults.walkTokens;
          i.walkTokens = function (i) {
            let t = [];
            return t.push(e.walkTokens.call(this, i)), n && (t = t.concat(n.call(this, i))), t;
          };
        }
        $e.setOptions(i);
      });
    }),
    ($e.walkTokens = function (e, n) {
      let i = [];
      for (const t of e)
        switch (((i = i.concat(n.call($e, t))), t.type)) {
          case "table":
            for (const e of t.header) i = i.concat($e.walkTokens(e.tokens, n));
            for (const e of t.rows) for (const t of e) i = i.concat($e.walkTokens(t.tokens, n));
            break;
          case "list":
            i = i.concat($e.walkTokens(t.items, n));
            break;
          default:
            $e.defaults.extensions && $e.defaults.extensions.childTokens && $e.defaults.extensions.childTokens[t.type]
              ? $e.defaults.extensions.childTokens[t.type].forEach(function (e) {
                  i = i.concat($e.walkTokens(t[e], n));
                })
              : t.tokens && (i = i.concat($e.walkTokens(t.tokens, n)));
        }
      return i;
    }),
    ($e.parseInline = xe(_e.lexInline, we.parseInline)),
    ($e.Parser = we),
    ($e.parser = we.parse),
    ($e.Renderer = me),
    ($e.TextRenderer = be),
  ...
  function Le(e) {
    ...
    let n = e
        ...
        .replace(/^(\d)/, "_$1"),
      i = Ee[n];
    return (i = Object.keys(Ee).includes(n) ? i + 1 : 0), (Ee[n] = i), i && (n = n + "-" + i), n;
  }
  Le.clear = function () {
    Ee = {};
  };
  ...
  function Ce(e, n) {
    return e
      .replace(/<(code|pre|script|template)[^>]*?>[\s\S]+?<\/(code|pre|script|template)>/g, (e) =>
        e.replace(/:/g, "__colon__")
      )
      .replace(/<!--[\s\S]+?-->/g, (e) => e.replace(/:/g, "__colon__"))
      .replace(/([a-z]{2,}:)?\/\/[^\s'">)]+/gi, (e) => e.replace(/:/g, "__colon__"))
      .replace(/:([a-z0-9_\-+]+?):/g, (e, i) =>
        (function (e, n, i) {
          const t = Re.data[n];
          let o = e;
          t &&
            (o =
              i && /unicode/.test(t)
                ? `<span class="emoji">${t
                    ...
                    .join("&zwj;")
                    .concat("&#xFE0E;")}</span>`
                : `<img src="${Re.baseURL}${t}.png" alt="${n}" class="emoji" loading="lazy">`);
          return o;
        })(e, i, n)
      )
      .replace(/__colon__/g, ":");
    ...
    return (
      e &&
        (e = e
          .replace(/^('|")/, "")
          .replace(/('|")$/, "")
          .replace(/(?:^|\s):([\w-]+:?)=?([\w-%]+)?/g, (e, i, t) =>
            -1 === i.indexOf(":") ? ((n[i] = (t && t.replace(/&quot;/g, "")) || !0), "") : e
          )
          .trim()),
      { str: e, config: n }
    );
        ...
        o = {
          ...
          languages: {
            ...
            insertBefore: function (e, n, i, t) {
              ...
              return (
                (t[e] = c),
                o.languages.DFS(o.languages, function (n, i) {
                  i === u && n != e && (this[n] = c);
                }),
                c
              );
              ...
              for (var r in n)
                if (n.hasOwnProperty(r)) {
                  ...
                  var s = n[r],
                    u = o.util.type(s);
                  "Object" !== u || a[c(s)]
                    ? "Array" !== u || a[c(s)] || ((a[c(s)] = !0), e(s, i, r, a))
                    : ((a[c(s)] = !0), e(s, i, null, a));
                }
            },
          },
          plugins: {},
          ...
          highlightElement: function (n, i, t) {
            ...
            if (
              ...
              (r = s.element.parentElement) &&
                "pre" === r.nodeName.toLowerCase() &&
                !r.hasAttribute("tabindex") &&
                r.setAttribute("tabindex", "0"),
              !s.code)
            )
              return o.hooks.run("complete", s), void (t && t.call(s.element));
        ...
        for (var g in i)
          if (i.hasOwnProperty(g) && i[g]) {
            ...
            for (var l = 0; l < p.length; ++l) {
              ...
              for (
                var w = v.pattern || v, y = t.next, x = s;
                y !== n.tail && !(f && x >= f.reach);
                ...
                if (!($ instanceof a)) {
                  ...
                  if (m) {
                    ...
                    var z = A.index,
                      ...
                      T = x;
                    for (T += y.value.length; z >= T; ) T += (y = y.next).value.length;
                    if (((x = T -= y.value.length), y.value instanceof a)) continue;
                    for (var F = y; F !== n.tail && (T < E || "string" == typeof F.value); F = F.next)
                      S++, (T += F.value.length);
                  ...
                  var O = y.prev;
                  if (
                    (R && ((O = u(n, O, R)), (x += R.length)),
                    d(n, O, S),
                    (y = u(n, O, new a(g, h ? o.tokenize(L, h) : L, b, L))),
                    C && u(n, y, C),
                    S > 1)
                  ) {
                  ...
                  (function (e, n, i) {
                      ...
                      (t.onreadystatechange = function () {
                        4 == t.readyState &&
                          (t.status < 400 && t.responseText
                            ? n(t.responseText)
                            : t.status >= 400
                            ? i("✖ Error " + t.status + " while fetching file: " + t.statusText)
                    ...
                    function (e) {
                      ...
                      if (t) {
                        var a = e.split(/\r\n?|\n/g),
                          c = t[0],
                          u = null == t[1] ? a.length : t[1];
                        c < 0 && (c += a.length),
                          (c = Math.max(0, Math.min(c - 1, a.length))),
                          u < 0 && (u += a.length),
                ...
                if ("string" == typeof u || (u.content && "string" == typeof u.content)) {
                  ...
                  if (l > -1) {
                    ...
                    var v = g.substring(0, l),
                      ...
                      _ = g.substring(l + p.length),
                      m = [];
                    v && m.push.apply(m, c([v])),
                      m.push(h),
                      _ && m.push.apply(m, c([_])),
                      "string" == typeof u ? r.splice.apply(r, [s, 1].concat(m)) : (u.content = m);
                  }
  ...
  class He {
    constructor(n, t) {
      (this.config = n),
        ...
        (this.toc = []),
        (this.cacheTOC = {}),
        (this.linkTarget = n.externalLinkTarget || "_blank"),
        (this.linkRel = "_blank" === this.linkTarget ? n.externalLinkRel || "noopener" : ""),
        (this.contentBase = t.getBasePath());
      const a = this._initRenderer();
      let c;
      this.heading = a.heading;
      const r = n.markdown || {};
      o(r) ? (c = r($e, a)) : ($e.setOptions(Object.assign(r, { renderer: Object.assign(a, r.renderer) })), (c = $e)),
        (this._marked = c),
        (this.compile = (t) => {
          let o = !0;
          const a = e((e) => {
              ...
              let a = "";
              return t
                ? ((a = i(t) ? c(t) : c.parser(t)), (a = n.noEmoji ? a : Ce(a, n.nativeEmoji)), Le.clear(), a)
                : t;
            })(t),
            r = this.router.parse().file;
          return o ? (this.toc = this.cacheTOC[r]) : (this.cacheTOC[r] = [...this.toc]), a;
        });
    }
    compileEmbed(e, n) {
      const { str: i, config: t } = je(n);
      let o;
      if (((n = i), t.include)) {
        let i;
        if ((S(e) || (e = R(this.contentBase, E(this.router.getCurrentPath()), e)), t.type && (i = Ne[t.type])))
          (o = i.call(this, e, n)), (o.type = t.type);
        else {
          let i = "code";
          /\.(md|markdown)/.test(e)
            ? (i = "markdown")
    ...
    _matchNotCompileLink(e) {
      ...
      for (const i of n) {
        if ((Ie[i] || (Ie[i] = new RegExp(`^${i}$`))).test(e)) return e;
      }
    }
    _initRenderer() {
      const e = new $e.Renderer(),
        { linkTarget: n, linkRel: i, router: t, contentBase: o } = this,
        a = this,
        c = {};
      return (
        (c.heading = e.heading =
          function (e, n) {
            let { str: i, config: o } = je(e);
            const c = { level: n, title: i },
              {
                content: r,
                ignoreAllSubs: s,
                ignoreSubHeading: u,
                ...
                return (
                  /<!-- {docsify-ignore} -->/g.test(e) &&
                    ((e = e.replace("\x3c!-- {docsify-ignore} --\x3e", "")), (i = !0)),
                  /{docsify-ignore}/g.test(e) && ((e = e.replace("{docsify-ignore}", "")), (i = !0)),
                  /<!-- {docsify-ignore-all} -->/g.test(e) &&
                    ((e = e.replace("\x3c!-- {docsify-ignore-all} --\x3e", "")), (n = !0)),
                  /{docsify-ignore-all}/g.test(e) && ((e = e.replace("{docsify-ignore-all}", "")), (n = !0)),
                  { content: e, ignoreAllSubs: n, ignoreSubHeading: i }
                );
              })(i);
            (i = r.trim()),
              (c.title = (function (e = "") {
              ...
              (c.ignoreAllSubs = s),
              (c.ignoreSubHeading = u);
            const d = Le(o.id || i),
              f = t.toURL(t.getCurrentPath(), { id: d });
            return (
              (c.slug = f),
              a.toc.push(c),
              `<h${n} id="${d}" tabindex="-1"><a href="${f}" data-id="${d}" class="anchor"><span>${i}</span></a></h${n}>`
            );
          }),
        (c.code = (({ renderer: e }) =>
          (e.code = function (e, n = "markup") {
            const i = Me.languages[n] || Me.languages.markup;
            return `<pre v-pre data-lang="${n}"><code class="lang-${n}" tabindex="0">${Me.highlight(
              e.replace(/@DOCSIFY_QM@/g, "`"),
              i,
              n
            )}</code></pre>`;
          }))({ renderer: e })),
        (c.link = (({ renderer: e, router: n, linkTarget: i, linkRel: t, compilerClass: o }) =>
          (e.link = (e, a = "", c) => {
            let r = [];
            const { str: s, config: u } = je(a);
            return (
              (i = u.target || i),
              (t = "_blank" === i ? o.config.externalLinkRel || "noopener" : ""),
              (a = s),
              S(e) || o._matchNotCompileLink(e) || u.ignore
                ? (S(e) ||
                    "./" !== e.slice(0, 2) ||
                    (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e),
                  r.push(0 === e.indexOf("mailto:") ? "" : `target="${i}"`),
                  r.push(0 === e.indexOf("mailto:") ? "" : "" !== t ? ` rel="${t}"` : ""))
                : (e === o.config.homepage && (e = "README"), (e = n.toURL(e, null, n.getCurrentPath()))),
              u.disabled && (r.push("disabled"), (e = "javascript:void(0)")),
              u.class && r.push(`class="${u.class}"`),
              u.id && r.push(`id="${u.id}"`),
              a && r.push(`title="${a}"`),
              `<a href="${e}" ${r.join(" ")}>${c}</a>`
            );
          }))({ renderer: e, router: t, linkTarget: n, linkRel: i, compilerClass: a })),
        (c.paragraph = (({ renderer: e }) =>
          (e.paragraph = (e) => {
            let n;
            return (n = /^!&gt;/.test(e) ? Se("tip", e) : /^\?&gt;/.test(e) ? Se("warn", e) : `<p>${e}</p>`), n;
          }))({ renderer: e })),
        (c.image = (({ renderer: e, contentBase: n, router: i }) =>
          (e.image = (e, t, o) => {
            let a = e,
              c = [];
            const { str: r, config: s } = je(t);
            if (((t = r), s["no-zoom"] && c.push("data-no-zoom"), t && c.push(`title="${t}"`), s.size)) {
              const [e, n] = s.size.split("x");
              n ? c.push(`width="${e}" height="${n}"`) : c.push(`width="${e}"`);
            }
            return (
              s.class && c.push(`class="${s.class}"`),
              s.id && c.push(`id="${s.id}"`),
              S(e) || (a = R(n, E(i.getCurrentPath()), e)),
              `<img src="${a}" data-origin="${e}" alt="${o}" ${c.join(" ")} />`
            );
          }))({ renderer: e, contentBase: o, router: t })),
        (c.list = (({ renderer: e }) =>
          (e.list = (e, n, i) => {
            const t = n ? "ol" : "ul";
            return `<${t} ${[
        ...
        (c.listitem = (({ renderer: e }) =>
          (e.listitem = (e) =>
            /^(<input.*type="checkbox"[^>]*>)/.test(e)
    ...
    sidebar(e, n) {
      const { toc: i } = this,
        t = this.router.getCurrentPath();
      let o = "";
      if (e) o = this.compile(e);
      else {
        for (let e = 0; e < i.length; e++)
          if (i[e].ignoreSubHeading) {
            const n = i[e].level;
            i.splice(e, 1);
            for (let t = e; t < i.length && n < i[t].level; t++) i.splice(t, 1) && t-- && e++;
            e--;
          }
        const e = this.cacheTree[t] || ze(i, n);
        (o = Ae(e, "<ul>{inner}</ul>")), (this.cacheTree[t] = e);
      }
      return o;
    }
    subSidebar(e) {
  ...
  const De = (e) => {
    const n = e.match(/^[ \t]*(?=\S)/gm);
    return n ? n.reduce((e, n) => Math.min(e, n.length), 1 / 0) : 0;
  };
  var Be = qe((e) => {
    const n = De(e);
    if (0 === n) return e;
    const i = new RegExp(`^[ \\t]{${n}}`, "gm");
    return e.replace(i, "");
  });
  let Ue, Ze;
  function Ve(e) {
    ...
    !Ue &&
      ...
      void 0 !== t
        ? ((o = parseInt(Ue.style.width || 0, 10) + t), (o = o > 80 ? 80 : o))
        : (o = Math.floor((n / i) * 100)),
      (Ue.style.opacity = 1),
      (Ue.style.width = o >= 95 ? "100%" : o + "%"),
      Ue.setAttribute("aria-valuenow", o >= 95 ? 100 : o),
      o >= 95 &&
        (clearTimeout(Ze),
        (Ze = setTimeout((e) => {
          (Ue.style.opacity = 0), (Ue.style.width = "0%"), Ue.removeAttribute("aria-valuenow");
        }, 200)));
  }
  const Qe = {};
  function Ye(e, n = !1, i = {}) {
    ...
    return (
      o.send(),
      {
        then(i, a = t) {
          ...
          if (n) {
            const e = setInterval((e) => Ve({ step: Math.floor(5 * Math.random() + 1) }), 500);
            o.addEventListener("progress", Ve),
              o.addEventListener("loadend", (n) => {
                Ve(n), clearInterval(e);
              });
          }
  ...
  const We = {};
  function Ge({ compiler: e, raw: n = "", fetch: i }, t) {
    let o = We[n];
    if (o) {
      const e = o.slice();
      return (e.links = o.links), t(e);
    }
    const a = e._marked;
    let c = a.lexer(n);
    const r = [],
      s = a.Lexer.rules.inline.link,
      u = c.links;
    c.forEach((n, i) => {
      "paragraph" === n.type &&
        (n.text = n.text.replace(new RegExp(s.source, "g"), (n, t, o, a) => {
          const c = e.compileEmbed(o, a);
          return c && r.push({ index: i, embed: c }), n;
        }));
    });
    const d = [];
    !(function ({ embedTokens: e, compile: n, fetch: i }, t) {
      let o,
        a = 0,
        c = 0;
      ...
      for (; (o = e[a++]); ) {
        const i = o,
          a = (o) => {
            let a;
            if (o)
              if ("markdown" === i.embed.type) {
                let e = i.embed.url.split("/");
                e.pop(),
                  (e = e.join("/")),
                  (o = o.replace(/\[([^[\]]+)\]\(([^)]+)\)/g, (n) => {
                    const i = n.indexOf("(");
                    return "(." === n.slice(i, i + 2)
                      ? n.substring(0, i) +
                  ...
                  !0 === (($docsify.frontMatter || {}).installed || !1) && (o = $docsify.frontMatter.parseMarkdown(o)),
                  (a = n.lexer(o));
              } else if ("code" === i.embed.type) {
                if (i.embed.fragment) {
                  const e = i.embed.fragment,
                    n = new RegExp(`(?:###|\\/\\/\\/)\\s*\\[${e}\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[${e}\\]`);
                  o = Be((o.match(n) || [])[1] || "").trim();
                }
                a = n.lexer("```" + i.embed.lang + "\n" + o.replace(/`/g, "@DOCSIFY_QM@") + "\n```\n");
              } else
                "mermaid" === i.embed.type
                  ? ((a = [{ type: "html", text: `<div class="mermaid">\n${o}\n</div>` }]), (a.links = {}))
                  : ((a = [{ type: "html", text: o }]), (a.links = {}));
            t({ token: i, embedToken: a }), ++c >= e.length && t({});
          };
        o.embed.url ? Ye(o.embed.url).then(a) : a(o.embed.html);
      }
    })({ compile: a, embedTokens: r, fetch: i }, ({ embedToken: e, token: i }) => {
      if (i) {
        let n = i.index;
        d.forEach((e) => {
          ...
          d.push({ start: n, length: e.length - 1 });
      } else (We[n] = c.concat()), (c.links = We[n].links = u), t(c);
    });
  }
  function Xe(e) {
    return class extends e {
        ...
        return (
          (n =
            "function" == typeof i
              ...
              ? ((a = []),
                (c = 0),
                (t = i).replace(I, function (e, n, i) {
                  a.push(t.substring(c, i - 1)),
                    (c = i += e.length + 1),
                    a.push(
                      (o && o[e]) ||
                        function (n) {
                          return ("00" + ("string" == typeof N[e] ? n[N[e]]() : N[e](n))).slice(-e.length);
                        }
                    );
                }),
                c !== t.length && a.push(t.substring(c)),
                function (e) {
                  for (var n = "", i = 0, t = e || new Date(); i < a.length; i++)
                    n += "string" == typeof a[i] ? a[i] : a[i](t);
                  return n;
                })(new Date(n))
              : n),
      ...
      #c(e) {
        ...
        if (
          ...
          (n.executeScript || ("Vue" in window && !1 !== n.executeScript)) && this.#o(),
          "Vue" in window)
        ) {
          const e = n.vueGlobalOptions || {},
            a = [],
            c = Object.keys(n.vueComponents || {});
          2 === t &&
            c.length &&
            c.forEach((e) => {
              !window.Vue.options.components[e] && window.Vue.component(e, n.vueComponents[e]);
            }),
            !this.#t && e.data && "function" == typeof e.data && (this.#t = e.data()),
            a.push(
              ...Object.keys(n.vueMounts || {})
                .map((e) => [g(i, e), n.vueMounts[e]])
                .filter(([e, n]) => e)
            );
          const r = /{{2}[^{}]*}{2}/,
            s = /<[^>/]+\s([@:]|v-)[\w-:.[\]]+[=>\s]/;
          if (
            (a.push(
              ...p(".markdown-section > *")
                .filter((e) => !a.some(([n, i]) => n === e))
                .filter(
                  (e) =>
                    e.tagName.toLowerCase() in (n.vueComponents || {}) ||
                    e.querySelector(c.join(",") || null) ||
                    r.test(e.outerHTML) ||
                    s.test(e.outerHTML)
                )
                .map((n) => {
                  const i = { ...e };
                  return this.#t && (i.data = () => this.#t), [n, i];
                })
            ),
            0 === a.length)
          )
          ...
          for (const [e, i] of a) {
            const a = "data-isvue";
            if (!(e.matches("pre, script") || o(e) || e.querySelector(`[${a}]`)))
              if ((e.setAttribute(a, ""), 2 === t)) (i.el = void 0), new window.Vue(i).$mount(e);
              else if (3 === t) {
      ...
      _renderSidebar(e) {
        ...
        const u = this.__getAndActive(this.router, ".sidebar-nav", !0, !0);
        t && u ? (u.parentNode.innerHTML += this.compiler.subSidebar(i) || "") : this.compiler.subSidebar(),
          this._bindEventOnRendered(u);
      }
      _bindEventOnRendered(e) {
        const { autoHeader: n } = this.config;
        if ((this.__scrollActiveSidebar(this.router), n && e)) {
          const n = s("#main"),
            i = n.children[0];
          if (i && "H1" !== i.tagName) {
      ...
      _renderNav(e) {
        e && this._renderTo("nav", this.compiler.compile(e)),
          this.config.loadNavbar && this.__getAndActive(this.router, "nav");
      }
      _renderMain(e, n = {}, i) {
        const { response: t } = this.route;
        !t || t.ok || (e && 404 === t.status) || (e = `# ${t.status} - ${t.statusText}`),
          this.callHook("beforeEach", e, (t) => {
            let o;
            const a = () => {
              n.updatedAt && (o = this.#a(o, n.updatedAt, this.config.formatUpdated)),
            ...
            this.isHTML
              ? ((o = this.result = e), a())
              : Ge({ compiler: this.compiler, raw: t }, (e) => {
      ...
      _renderCover(e, n) {
        const i = s(".cover");
        if ((b(s("main"), n ? "add" : "remove", "hidden"), !e)) return void b(i, "remove", "show");
        b(i, "add", "show");
        let t = this.coverIsHTML ? e : this.compiler.cover(e);
        const o = t.trim().match('<p><img.*?data-origin="(.*?)"[^a]+alt="(.*?)">([^<]*?)</p>$');
        if (o) {
          if ("color" === o[2]) i.style.background = o[1] + (o[3] || "");
          else {
            let e = o[1];
            b(i, "add", "has-mask"),
              S(o[1]) || (e = R(this.router.getBasePath(), o[1])),
        ...
        this._renderTo(".cover-main", t), this.__sticky();
      }
      _updateRender() {
        this.#r(this), this.#s(this);
      }
      initRender() {
        const e = this.config;
        (this.compiler = new He(e, this.router)), (window.__current_docsify_compiler__ = this.compiler);
        const n = g(e.el || "#app");
        if (n) {
          let o = "";
          if (
            ...
            const n = /^data:image/.test(e.logo),
              i = /(?:http[s]?:)?\/\//.test(e.logo),
              t = /^\./.test(e.logo);
            n || i || t || (e.logo = R(this.router.getBasePath(), e.logo));
          }
          (o += (function (e) {
        ...
        if (e.loadNavbar) {
          ...
          n.setAttribute("aria-label", "secondary"),
            i
              ? g(".sidebar").prepend(n)
              : (d.prepend(n), n.classList.add("app-nav"), n.classList.toggle("no-badge", !e.repo));
        }
        e.themeColor &&
          u.head.appendChild(
            l("div", ((o = e.themeColor), `<style>:root{--theme-color: ${o};}</style>`)).firstElementChild
          ),
          this._updateRender(),
          b(d, "ready");
      }
  ...
  var nn = (function () {
    function e() {
      ...
      !(function (e, n) {
        ...
        (this.tweener = n.tweener || new Je(n)),
      ...
      en(e, [
        ...
        },
        {
          ...
          value: function (e, n, i, t) {
            return (e /= t / 2) < 1 ? (i / 2) * e * e + n : (-i / 2) * (--e * (e - 2) - 1) + n;
          },
        },
      ]),
      e
  ...
  const tn = document.currentScript;
  function on(e) {
    ...
    const o = tn || Array.from(document.getElementsByTagName("script")).filter((e) => /docsify\./.test(e.src))[0];
    if (o)
  ...
  class cn extends (function (e) {
    return class extends e {
      #u(e, n, i, t, o, a) {
        (e = a ? e : e.replace(/\/$/, "")),
          (e = E(e)) &&
            Ye(o.router.getFile(e + i) + n, !1, o.config.requestHeaders).then(t, (a) => this.#u(e, n, i, t, o));
      }
      #d;
      #f = () => this.#d && this.#d.abort && this.#d.abort();
      #g = (e, n) => (this.#f(), (this.#d = Ye(e, !0, n)), this.#d);
      #p = (e, n) => {
        const { notFoundPage: i, ext: t } = n,
          o = "_404" + (t || ".md");
        let a, c;
        switch (typeof i) {
          case "boolean":
      ...
      _fetch(e = t) {
        ...
        let { path: i } = this.route;
        if (a(i)) history.replaceState(null, "", "#"), this.router.normalize();
        else {
          const t = A(n, ["id"]),
            { loadNavbar: o, requestHeaders: c, loadSidebar: r } = this.config,
          ...
          this.isRemoteUrl
            ? this.#g(s + t, c).then(u, d)
            : this.matchVirtualRoute(i).then((e) => {
                "string" == typeof e ? u(e) : this.#g(s + t, c).then(u, d);
              }),
            o && this.#u(i, t, o, (e) => this._renderNav(e), this, !0);
        }
      }
      _fetchCover() {
        ...
        if (e) {
          ...
          return (
            o
              ? ((o = this.router.getFile(t + o)),
                (this.coverIsHTML = /\.html$/g.test(o)),
                Ye(o + A(i, ["id"]), !1, n).then((e) => this._renderCover(e, c)))
              : this._renderCover(null, c),
            c
          );
        }
      }
      $fetch(e = t, n = this.$resetEvents.bind(this)) {
        const i = () => {
      ...
      _fetchFallbackPage(e, n, i = t) {
        ...
        return (
          this.#g(s + n, o).then(
            (t, o) => this._renderMain(t, o, this._loadSideAndNav(e, n, c, i)),
            (t) => this._fetch404(e, n, i)
          ),
          !0
        );
      }
      _fetch404(e, n, i = t) {
        ...
        if (c) {
          const n = this.#p(e, this.config);
          return (
            this.#g(this.router.getFile(n), a).then(
              (e, n) => this._renderMain(e, n, r),
              (e) => this._renderMain(null, {}, r)
            ),
            !0
          );
        }
      ...
      initFetch() {
        const { loadSidebar: e } = this.config;
        if (this.rendered) {
          const n = this.__getAndActive(this.router, ".sidebar-nav", !0, !0);
          e && n && (n.parentNode.innerHTML += window.__SUB_SIDEBAR__),
            this._bindEventOnRendered(n),
            this.$resetEvents(),
            this.callHook("doneEach"),
            this.callHook("ready");
        } else this.$fetch((e) => this.callHook("ready"));
      }
    };
  })(
    (function (e) {
      return class extends e {
        $resetEvents(e) {
          const { auto2top: n, loadNavbar: i } = this.config,
            { path: t, query: o } = this.route;
          "history" !== e && (o.id ? this.#l(t, o.id, !0) : "navigate" === e && n && this.#v(n)),
            (o.id || "navigate" === e) && this.#h(),
            i && this.__getAndActive(this.router, "nav");
        }
        initEvent() {
          const { coverpage: e, keyBindings: n } = this.config,
            i = ["alt", "ctrl", "meta", "shift"];
          this.#_("#skip-to-content"),
            this.#m("button.sidebar-toggle", this.router),
            this.#b(".sidebar", this.router),
            e ? !c && _("scroll", this.__sticky) : d.classList.add("sticky"),
            n &&
              n.constructor === Object &&
              (Object.values(n || []).forEach((e) => {
                const { bindings: n } = e;
                n &&
                  ((e.bindings = Array.isArray(n) ? n : [n]),
                  ...
                  .filter(
                    ({ bindings: n }) =>
                      ...
                      n.some((n) =>
                        n.every(
                          (n) =>
                            (i.includes(n) && e[n + "Key"]) ||
                            e.key === n ||
                            e.code.toLowerCase() === n ||
                            e.code.toLowerCase() === `key${n}`
                        )
                      )
                  )
                  .forEach(({ callback: n }) => {
        ...
        #$ = 0;
        #_(e) {
          (e = "string" == typeof e ? g(e) : e),
            e?.addEventListener("click", (e) => {
              e.preventDefault(), s("main")?.scrollIntoView({ behavior: "smooth" }), this.#h({ preventScroll: !0 });
            });
        }
        #A(e, n = 0) {
          this.#y && this.#y.stop(),
            ...
            (this.#y = new nn({
              ...
              end: Math.round(e.getBoundingClientRect().top) + window.pageYOffset - n,
              duration: 500,
            })
              .on("tick", (e) => window.scrollTo(0, e))
              .on("done", () => {
        ...
        #S(e) {
          ...
          const a = document.documentElement,
            c = ((a && a.scrollTop) || document.body.scrollTop) - this.#$;
          let r;
          for (const e of i) {
            if (e.offsetTop > c) {
              r || (r = e);
          ...
          if (!r) return;
          const u = this.#k[this.#z(e, r.getAttribute("data-id"))];
          if (
            u &&
            u !== o &&
            ...
            (o = u),
            !this.#w && d.classList.contains("sticky"))
          ) {
            const e = n.clientHeight,
              i = 0,
              a = o.offsetTop + o.clientHeight + 40,
              c = o.offsetTop >= t.scrollTop && a <= t.scrollTop + e,
              r = a - i < e;
            n.scrollTop = c ? t.scrollTop : r ? i : a - e;
          }
        }
        #z(e, n) {
          return `${decodeURIComponent(e)}?id=${decodeURIComponent(n)}`;
        }
        __scrollActiveSidebar(e) {
          const n = g(".cover.show");
          this.#$ = n ? n.offsetHeight : 0;
          const i = s(".sidebar");
          let t = [];
          null != i && (t = p(i, "li"));
          for (const n of t) {
            ...
            t && (this.#k[decodeURIComponent(t)] = n);
          }
          if (c) return;
          const o = z(e.getCurrentPath());
          m("scroll", () => this.#S(o)),
            _("scroll", () => this.#S(o)),
            _(i, "mouseover", () => {
              this.#w = !0;
        ...
        #l(e, n) {
          ...
          const o = s(".sidebar"),
            ...
            c = g(o, "[aria-current]"),
            r = this.#k[this.#z(e, n)],
            u = g(o, `[href$="${e}"]`)?.parentNode;
          a?.classList.remove("active"),
            c?.removeAttribute("aria-current"),
            r?.classList.add("active"),
            u?.setAttribute("aria-current", "page");
        }
        #E = u.scrollingElement || u.documentElement;
        #v(e = 0) {
          this.#E.scrollTop = !0 === e ? 0 : Number(e);
        }
        #T = u.title;
        #m(e) {
          const n = (n) => {
            d.classList.toggle("close");
            const i = c ? d.classList.contains("close") : !d.classList.contains("close");
          ...
          null != (e = s(e)) &&
            ...
            c && _(d, "click", (e) => d.classList.contains("close") && n()));
        }
        #b(e) {
          null != (e = s(e)) &&
            _(e, "click", ({ target: e }) => {
              "A" === e.nodeName &&
                ...
                b(e.parentNode, "collapse");
            });
        }
        __sticky = () => {
          const e = s("section.cover");
          if (!e) return;
          const n = e.getBoundingClientRect().height;
          window.pageYOffset >= n || e.classList.contains("hidden") ? b(d, "add", "sticky") : b(d, "remove", "sticky");
        };
        __getAndActive(e, n, i, t) {
          let o = [];
          null != (n = s(n)) && (o = p(n, "a"));
          const a = decodeURI(e.toURL(e.getCurrentPath()));
          let c;
          return (
            o
              .sort((e, n) => n.href.length - e.href.length)
              .forEach((e) => {
                const n = decodeURI(e.getAttribute("href")),
                  t = i ? e.parentNode : e;
                (e.title = e.title || e.innerText),
                  0 !== a.indexOf(n) || c
                    ? (b(t, "remove", "active"), t.removeAttribute("aria-current"))
                    : ((c = e), b(t, "add", "active"), t.setAttribute("aria-current", "page"));
              }),
            t && (u.title = c ? c.title || `${c.innerText} - ${this.#T}` : this.#T),
            c
          );
        }
      };
            ...
            return class extends e {
              ...
              updateRender() {
                this.router.normalize(),
                  ...
                  d.setAttribute("data-page", this.route.file);
              }
              initRouter() {
                const e = this.config;
                let n;
                (n = "history" === (e.routerMode || "hash") ? new P(e) : new q(e)),
                  (this.router = n),
                  this.updateRender(),
                  (M = this.route),
                  n.onchange((e) => {
                    this.updateRender(),
                      ...
                      M.path !== this.route.path
                        ? (this.$fetch(t, this.$resetEvents.bind(this, e.source)), (M = this.route))
                        : this.$resetEvents(e.source);
                  });
              }
            };
          })(
  ...
  (window.Docsify = { util: rn, dom: w, get: Ye, slugify: Le, version: "4.13.0" }),
    (window.DocsifyCompiler = He),
    (window.marked = $e),
    (window.Prism = Me),
    k(() => new cn());
})();
